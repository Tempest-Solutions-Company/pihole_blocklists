...
**Last Updated:** 2025-09-28 15:37:05 UTC

## 📊 Performance Statistics

- **Phishing Domains:** 472,183
- **Malware Domains:** 9,607
- **C2 Server Domains:** 19,139
...
|------|-------------|---------|----------|
| Phishing | Phishing domains and URLs | 472,183 | [Download](phishing.txt) |
| Malware | Malware hosting & distribution sites | 9,607 | [Download](malware.txt) |
| C2 Servers | Command & control servers | 19,139 | [Download](c2_servers.txt) |
| Banking Trojan | Banking trojan & financial malware | 5,649 | [Download](banking_trojan.txt) |
| All Malicious | All threats combined | 504,777 | [Download](all_malicious.txt) |
